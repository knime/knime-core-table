...
public class MaxDouble implements AggregateTransformSpec.AggregatorFactory<MaxDouble.Agg> {
    ...
    class AggRowAccessible implements RowAccessible, Consumer<Agg> {
        ...
        public Cursor<ReadAccessRow> createCursor(Selection selection) {
            return new AggRowAccessible.AggCursor(selection);
        }
        ...
        class AggCursor implements Cursor<ReadAccessRow> {
            ...
            private BufferedAccesses.BufferedAccessRow m_access =
                    BufferedAccesses.createBufferedAccessRow(getOutputSchema());
            ...
            public boolean forward() {
                ...
                ((DoubleAccess.DoubleWriteAccess)m_access.getBufferedAccess(0)).setDoubleValue(agg.max);
                canForward = false;
                return true;
            }
