...
public final class AstTestUtils {
     ...
     */
    public static Ast.BooleanConstant BOOL(final boolean value) {
     ...
     */
    public static Ast.IntegerConstant INT(final long value) {
     ...
     */
    public static Ast.FloatConstant FLOAT(final double value) {
     ...
     */
    public static Ast.StringConstant STR(final String value) {
     ...
     */
    public static Ast.ColumnAccess COL(final String name) {
     ...
     */
    public static Ast.BinaryOp OP(final Ast leftArg, final Ast.BinaryOperator op, final Ast rightArg) {
     ...
     */
    public static Ast.UnaryOp OP(final Ast.UnaryOperator op, final Ast arg) {
     ...
     */
    public static Ast.FunctionCall FUN(final String name, final Ast... args) {
