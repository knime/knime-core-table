...
final class StringFunctionTests {
    ...
    List<DynamicNode> capitalize() {
        return new FunctionTestBuilder(StringFunctions.CAPITALIZE) //
            ...
            .impl("capitalise ALL CAPS", List.of(arg("BACKPORT IS FUN")), "Backport Is Fun") //
            .impl("noop", List.of(arg("A")), "A") //
            .tests();
    }
    ...
    List<DynamicNode> substr() {
        return new FunctionTestBuilder(StringFunctions.SUBSTRING) //
            ...
            .typing("optional_start", List.of(STRING, OPT_INTEGER), STRING)
            .typing("optional length", List.of(STRING, INTEGER, OPT_INTEGER), STRING) //
            .typing("optional_start+length", List.of(STRING, OPT_INTEGER, OPT_INTEGER), STRING)
            ...
            .impl("length is negative", List.of(arg("abc"), arg(1), arg(-1)), "") //
            .impl("length is negative and start missing", List.of(arg("abc"), misInteger(), arg(-1)), "") //
            .impl("length is very large", List.of(arg("abc"), arg(1), arg(Integer.MAX_VALUE)), "abc") //
            .impl("length is very large and start missing", List.of(arg("abc"), misInteger(), arg(Integer.MAX_VALUE)),
                "abc") //
