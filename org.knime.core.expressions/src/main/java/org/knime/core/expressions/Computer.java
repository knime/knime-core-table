...
public interface Computer {
     ...
     */
    @FunctionalInterface
    public interface BooleanComputerResultSupplier {
        /**
     ...
     */
    @FunctionalInterface
    public interface IntegerComputerResultSupplier {
        /**
         * Applies the computer with the given context.
         *
         * @param ctx the evaluation context
     ...
     */
    @FunctionalInterface
    public interface FloatComputerResultSupplier {
        /**
         * Applies the computer with the given context.
         *
         * @param ctx the evaluation context
     ...
     */
    @FunctionalInterface
    public interface ComputerResultSupplier<O> {
        /**
         * Applies the computer with the given context.
         *
         * @param ctx the evaluation context
