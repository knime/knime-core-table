...
public final class MathFunctions {
    ...
    public static final OperatorCategory CATEGORY_GENERAL = OperatorCategory.inferFullName("""
    ...
    public static final OperatorCategory CATEGORY_ROUND = OperatorCategory.inferFullName("""
    ...
    public static final OperatorCategory CATEGORY_AGGREGATE = OperatorCategory.inferFullName("""
    ...
    public static final OperatorCategory CATEGORY_TRIGONOMETRY = OperatorCategory.inferFullName("""
    ...
    public static final OperatorCategory CATEGORY_DISTRIBUTIONS = OperatorCategory.inferFullName("""
    ...
    public static final ExpressionFunction MAX = functionBuilder() //
        ...
        .description("""
                ...
                * `max(1, 2, NaN)` returns `NaN`
                """) //
        .keywords("maximum") //
        .category(CATEGORY_AGGREGATE.fullName()) //
        .args( //
    ...
    public static final ExpressionFunction ABS = functionBuilder() //
        ...
        .description("""
                ...
                * `abs(NaN)` returns `NaN`
                """) //
        .keywords("absolute") //
        .category(CATEGORY_GENERAL.fullName()) //
    ...
    public static final ExpressionFunction SIN = functionBuilder() //
        ...
        .description("""
                ...
                * `sin(NaN)` returns `NaN`
                """) //
        .keywords() //
        .category(CATEGORY_TRIGONOMETRY.fullName()) //
    ...
    public static final ExpressionFunction FLOOR = functionBuilder() //
        ...
        .description("""
                ...
                * `floor(1.0)` returns 1
                """) //
        .keywords() //
        .category(CATEGORY_ROUND.fullName()) //
        .args(arg("x", "A number", isNumericOrOpt())) //
    ...
    public static final ExpressionFunction BINOMIAL = functionBuilder() //
        ...
        .category(CATEGORY_DISTRIBUTIONS.fullName()) //
        .args( //
