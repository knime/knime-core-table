...
public final class StringFunctions {
	...
	public static final FunctionCategory CATEGORY = new FunctionCategory("String Manipulation",
	...
	public static final ExpressionFunction SUBSTR = functionBuilder() //
			...
			.args( //
					...
					optarg("length",
							"length - if unspecified, or bigger than the string, get entire string after the start",
							isInteger()) //
			) //
