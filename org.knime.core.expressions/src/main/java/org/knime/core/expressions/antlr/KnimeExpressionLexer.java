...
public class KnimeExpressionLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "WHITESPACE", "BOOLEAN", "INTEGER", "NON_ZERO_DIGIT", 
			"DIGIT", "FLOAT", "POINT_FLOAT", "EXPONENT_FLOAT", "DIGIT_PART", "EXPONENT", 
			"FRACTION", "STRING", "ESC", "MISSING", "PLUS", "MINUS", "MULTIPLY", 
			"DIVIDE", "FLOOR_DIVIDE", "EXPONENTIATE", "MODULO", "LESS_THAN", "LESS_THAN_OR_EQUAL", 
