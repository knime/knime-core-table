...
/**
 * The definition of an aggregation that can be used in expressions. Note that the implementation is not part of this
 * interface because it is applied on types that are not accessible here.
 *
