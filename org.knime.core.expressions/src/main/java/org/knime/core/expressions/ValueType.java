...
public interface ValueType {
     ...
     */
    static ValueType BOOLEAN(final boolean optional) {
     ...
     */
    static ValueType INTEGER(final boolean optional) {
     ...
     */
    static ValueType FLOAT(final boolean optional) {
     ...
     */
    static ValueType STRING(final boolean optional) {
