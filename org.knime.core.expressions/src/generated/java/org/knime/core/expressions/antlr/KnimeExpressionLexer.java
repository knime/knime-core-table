...
public class KnimeExpressionLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"WHITESPACE", "BOOLEAN", "INTEGER", "NON_ZERO_DIGIT", "DIGIT", "FLOAT", 
			"POINT_FLOAT", "EXPONENT_FLOAT", "DIGIT_PART", "EXPONENT", "FRACTION", 
			"STRING", "ESC", "UNICODE_16", "HEX_DIGIT", "MISSING", "PLUS", "MINUS", 
