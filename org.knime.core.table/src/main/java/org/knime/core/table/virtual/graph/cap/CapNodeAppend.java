...
public class CapNodeAppend extends CapNode {
    ...
    public CapNodeAppend(final int index, final CapAccessId[] inputs, //
            final int[] predecessors, final long[] predecessorSizes, //
            final int[] validityProviders, final long[] validitySizes, final int[][] validityOutputIndices) {
