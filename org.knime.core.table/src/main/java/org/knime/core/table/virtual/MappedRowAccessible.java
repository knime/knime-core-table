 ...
 */
class MappedRowAccessible implements RowAccessible {
    ...
    public MappedRowAccessible(final RowAccessible tableToMap, final MapperSpec factory) {
        m_delegateTable = tableToMap;
        m_mapper = factory.create();
        m_schema = factory.getOutputSchema();
    }
