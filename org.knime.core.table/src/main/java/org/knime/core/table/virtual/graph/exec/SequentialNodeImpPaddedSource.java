...
class SequentialNodeImpPaddedSource implements SequentialNodeImp {
    ...
    SequentialNodeImpPaddedSource(final RowAccessible accessible, final int[] cols, final long fromRow, final long toRow) {
