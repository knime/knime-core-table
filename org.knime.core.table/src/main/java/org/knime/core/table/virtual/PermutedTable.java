 ...
 */
class PermutedTable implements RowAccessible {
    ...
    public PermutedTable(final RowAccessible tableToPermute, final int[] permutation,
        final ColumnarSchema permutedSchema) {
        m_delegateTable = tableToPermute;
        m_permutation = permutation;
        m_schema = permutedSchema;
    }
    ...
    public Cursor<ReadAccessRow> createCursor() {
        return new PermutedCursor(m_delegateTable.createCursor(), m_permutation, m_schema);
    }
