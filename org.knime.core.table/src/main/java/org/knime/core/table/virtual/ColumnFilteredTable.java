 ...
 */
class ColumnFilteredTable implements RowAccessible {
    ...
    public ColumnFilteredTable(final RowAccessible tableToFilter, final int[] columnIndices,
        final ColumnarSchema filteredSchema) {
